"Options"
{
	"Portal"
	{
		...
		"items"
		{
			"PortalDepth"
			{
				"text"			"#GameUI_PortalDepthLabel"
				"type"			"wheelywheel"
				"convar"		"r_portal_stencil_depth"

				"options"
				{
					"0"	"#GameUI_PortalDepth0"
					"1"	"#GameUI_PortalDepth1"
					"2"	"#GameUI_PortalDepth2"
					"3"	"#GameUI_PortalDepth3"
					"4"	"#GameUI_PortalDepth4"
					"5"	"#GameUI_PortalDepth5"
					"6"	"#GameUI_PortalDepth6"
					"7"	"#GameUI_PortalDepth7"
					"8"	"#GameUI_PortalDepth8"
					"9"	"#GameUI_PortalDepth9"
				}
			}
			"PortalFunnel"
			{
